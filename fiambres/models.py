...
class Product(models.Model):
    ...
    categoria_usuario = models.ForeignKey(Categoria_Usuario, on_delete=models.CASCADE,default=1)
...
class Order(models.Model):
    ...
    factura= models.ImageField(upload_to='facturas/', blank =True)
    ...
    def image_tag(self):
        return mark_safe('<img src="/media/facturas/%s" width="50" height="50" />' % (self.factura))
