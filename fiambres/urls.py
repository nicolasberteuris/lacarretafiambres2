...
from .views import CrearCategorias, CrearModalPrecios, CrearModalProductos, CrearModalUnidadMedida, CrearProductos, CrearUnidadMedida, EditarPrecios, EditarProductos, EditarUnidadMedida, EliminarPrecios, EliminarProductos, EliminarUnidadMedida, Verfactura, buscar_categoriass, buscar_categoriass_sinprecio, buscar_pedido2, buscar_precios, buscar_productos, buscar_unidadmedida, buscar_usuarios_ordenes_historico, checkout, listado_productos,buscar_categorias,detail, ListadoPedidos, listado_productos_sinprecio, ofertas, pagar, verfactura
...
urlpatterns = [
    ...
    path('listado_productos_sinprecio/',(listado_productos_sinprecio), name = 'listado_productos_sinprecio'),
    ...
    path('categories_sinprecio/<id>', (buscar_categoriass_sinprecio), name = 'categories_sinprecio'),
    ...
    path('factura_id/<id>', login_required(verfactura), name = 'factura_id'),
